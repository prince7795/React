...
export default function Product() {
    const [productData, setProductData] = useState({productId: '', productName: '', category:'', descroption:'', expiryDate:''})
    const  {productId, productName, category, descroption, expiryDate} = productData;
    ...
    const onSubmit = (e) => {
        ...
        axios
          .put("http://localhost:9030/api/product/"+productDetails.productId, productDetails)
